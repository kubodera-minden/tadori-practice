        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 3;
              return axios.get("/api/articles/".concat(_this.$route.params.id)).then(function (response) {
                return _this.article = response.data, _this.SavedContent = JSON.parse(response.data.content);
              });
