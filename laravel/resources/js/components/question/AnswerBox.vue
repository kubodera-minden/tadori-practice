    ...
    <div class="row justify-content-end">
        <div class="container mt-4 d-flex align-items-center">
            <div class="col-8 border p-4 offset-2">
                ...
                <div class="" v-else-if="question.opening_comment == ''">
                ...
                <div class="" v-else-if="question.interviewer_comment == ''">
  ...
  props: [
    ...
    methods: {
        createOpeningComment: async function() {
            await axios
                .post(`/api/update_question/${this.question.id}`,{opening_comment: this.answer.content,interviewer_comment: this.question.interviewer_comment})
                .then(response => (
        ...
        createInterviewerComment: async function() {
            await axios
                .post(`/api/update_question/${this.question.id}`,{interviewer_comment: this.answer.content,opening_comment: this.question.opening_comment})
                .then(response => (
                    this.$router.go({path: this.$router.currentRoute.path, force: true})
                ))
        }
